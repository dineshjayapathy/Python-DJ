...
some_jira = JIRA(options={'server': 'https://jira.arcadiasolutions.com'}, basic_auth=(config.username, config.password))
...
class Issue(object):
    ...
    #     requires = ((self.summary, "summary"), (self.project, "project"), (self.issuetype, "issue_type"),
